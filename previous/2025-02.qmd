...
date: 2025-02-24
authors:
  - name: Kevin Brown MBE CPhys FlnstP
author: Kevin Brown MBE CPhys FlnstP
categories: [environment]
---

::: {.img-float}
![](/posters/2025-02.jpg){width=30% fig-alt="Poster image for talk entitled Lowering Our Carbon Footprint: A Personal Journey" style="float: right; margin: 5px;"}
:::
...
* Kevin's presentation: [Lowering Our Carbon Footprint](resources/2025-02_presentation.pdf){target="_blank"}
